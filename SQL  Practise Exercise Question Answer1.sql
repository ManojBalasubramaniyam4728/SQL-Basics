/** Setup:-
Create a Table which looks like below table name as BOOK_INFORMATION
Column Name
BOOK_ID
BOOK_TITLE
PRICE 
...
create table BOOK_INFORMATION(BOOK_ID int(50), BOOK_TITLE varchar(50), PRICE int(50));
insert into BOOK_INFORMATION values(1,'Selenium webdriver',45);
insert into BOOK_INFORMATION values(2,'SQL',15);
insert into BOOK_INFORMATION values(3,'java',20);
insert into BOOK_INFORMATION values(4,'appium',22);
insert into BOOK_INFORMATION values(15,'python',18);
INSERT INTO BOOK_INFORMATION VALUES (18,'ELEMENTARY SCHOOL GUIDE',16);
INSERT INTO BOOK_INFORMATION VALUES (9,'Manual Testing',16);
...
Answer=> b) SELECT * FROM BOOK_INFORMATION;
*/
...
Answer=> d) SELECT BOOK_ID FROM BOOK_INFORMATION WHERE PRICE > 20;
*/
SELECT BOOK_ID FROM BOOK_INFORMATION WHERE PRICE > 20;
...
Answer=> c) SELECT BOOK_ID, BOOK_TITLE FROM BOOK_INFORMATION WHERE BOOK_TITLE LIKE 'A%';
*/
...
Answer=> a) SELECT BOOK_ID, BOOK_TITLE, PRICE FROM BOOK_INFORMATION ORDER BY PRICE DESC;
*/
SELECT BOOK_ID, BOOK_TITLE, PRICE FROM BOOK_INFORMATION ORDER BY PRICE DESC;
...
Answer=> c) INSERT INTO BOOK_INFORMATION VALUES (20,'1KEYDATA SQL TUTORIAL',15);
*/
INSERT INTO BOOK_INFORMATION VALUES (20,'1KEYDATA SQL TUTORIAL',15);
...
Answer=> d) DROP TABLE BOOK_INFORMATION;
*/
...
Answer=>b) DELETE FROM BOOK_INFORMATION WHERE BOOK_ID = 15;
*/
DELETE FROM BOOK_INFORMATION WHERE BOOK_ID = 15;
...
Answer=> a) UPDATE BOOK_INFORMATION SET PRICE = 20 WHERE BOOK_TITLE = 'ELEMENTARY SCHOOL GUIDE';
*/
...
Answer=> Both option c and d
c) SELECT BOOK_ID, BOOK_TITLE, PRICE FROM BOOK_INFORMATION WHERE PRICE BETWEEN 15 AND 20;
d) SELECT BOOK_ID, BOOK_TITLE, PRICE FROM BOOK_INFORMATION HAVING PRICE BETWEEN 15 AND 20;
*/
SELECT BOOK_ID, BOOK_TITLE, PRICE FROM BOOK_INFORMATION HAVING PRICE BETWEEN 15 AND 20;
SELECT BOOK_ID, BOOK_TITLE, PRICE FROM BOOK_INFORMATION WHERE PRICE BETWEEN 15 AND 20;
